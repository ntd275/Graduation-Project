...
function IconVideo() {
  return (
    <svg style={{ height: 24, width: 24 }} fill="#F3425F" viewBox="0 0 24 24">
...
function IconImage() {
  return (
    <svg fill="#45BD62" viewBox="0 0 24 24" style={{ height: 24, width: 24 }}>
      <g fillRule="evenodd" transform="translate(-444 -156)">
        <g>
          <path
...
function IconLike2() {
  return <i className="i-icon-like"></i>;
}

function IconComment() {
  return <i className="i-icon-comment"></i>;
}
